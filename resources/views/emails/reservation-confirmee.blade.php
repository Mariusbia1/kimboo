    ...
    <div style="max-width:600px; margin:40px auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <div style="padding:40px 32px;">
            ...
            <p style="margin:0 0 24px; font-size:15px; color:#555; line-height:1.6;">
                ...
                Votre professeur a confirmé votre réservation. Préparez-vous pour votre cours !
            </p>

            <div style="background:#F0FFF4; border-radius:12px; padding:20px; margin-bottom:28px; border-left:4px solid #22C55E;">
                <p style="margin:0 0 6px; font-size:13px; color:#999; text-transform:uppercase; font-weight:600;">Détails du cours</p>
                ...
                <p style="margin:8px 0 0; font-size:15px; font-weight:700; color:#22C55E;">
                    Confirmé
                </p>
            </div>
