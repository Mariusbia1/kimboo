    ...
    <div style="max-width:600px; margin:40px auto; background:#ffffff; border-radius:16px; overflow:hidden; box-shadow:0 4px 24px rgba(0,0,0,0.08);">
        ...
        <div style="padding:40px 32px;">
            <h2 style="margin:0 0 8px; font-size:22px; font-weight:800; color:#000;">
                Votre cours n'a pas été approuvé
            </h2>
            <p style="margin:0 0 24px; font-size:15px; color:#555; line-height:1.6;">
                Bonjour <strong>{{ $course->teacherProfile->user->name }}</strong>,<br>
                Après examen, votre cours n'a pas pu être approuvé pour le moment.
            </p>

            <!-- Card cours -->
            <div style="background:#F9FAFB; border-radius:12px; padding:20px; margin-bottom:20px; border-left:4px solid #EF4444;">
                <p style="margin:0 0 6px; font-size:13px; color:#999; text-transform:uppercase; font-weight:600;">Cours refusé</p>
            ...
            <div style="background:#FEF2F2; border-radius:12px; padding:16px 20px; margin-bottom:28px;">
                <p style="margin:0 0 4px; font-size:13px; font-weight:700; color:#EF4444;">Raison du refus :</p>
                <p style="margin:0; font-size:14px; color:#666; line-height:1.6;">{{ $course->rejection_reason }}</p>
            </div>
            @endif

            <p style="margin:0 0 24px; font-size:14px; color:#555; line-height:1.6;">
                Vous pouvez modifier votre cours et le resoumettre pour validation.
            </p>
