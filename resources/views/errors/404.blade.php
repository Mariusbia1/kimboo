...
<head>
    ...
    <title>Page introuvable • Kimboo</title>
    <!-- Favicon -->
...
<body>
    ...
    <main class="card">
        ...
        <h1>Cette page semble introuvable</h1>

        <p class="description">
            L'adresse saisie n'existe pas ou la page a été déplacée. Retrouvez vos cours et professeurs facilement depuis l'accueil.
        </p>
