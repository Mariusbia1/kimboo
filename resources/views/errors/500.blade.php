...
<head>
    ...
    <title>Une erreur est survenue • Kimboo</title>
    <!-- Favicon -->
...
<body>
    ...
    <main class="card">
        ...
        <h1>Une anomalie temporaire est survenue</h1>

        <p class="description">
            Nos équipes techniques ont été automatiquement alertées et travaillent à rétablir la situation dans les meilleurs délais. Vos données sont préservées en toute sécurité.
        </p>
